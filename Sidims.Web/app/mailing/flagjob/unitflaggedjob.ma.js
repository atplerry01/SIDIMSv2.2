(function () {
    'use strict';
    var controllerId = 'UnitFlaggedJobMA';
    angular
        .module('app')
        .controller('UnitFlaggedJobMA', UnitFlaggedJobMA);

    UnitFlaggedJobMA.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function UnitFlaggedJobMA($location, $scope, common, datacontext, model, resourceService) {
