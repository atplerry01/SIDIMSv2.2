(function () {
    'use strict';
    var controllerId = 'NonPersoJobRM';
    angular
        .module('app')
        .controller('NonPersoJobRM', NonPersoJobRM);

    NonPersoJobRM.$inject = ['$location', 'common', 'datacontext'];

    function NonPersoJobRM($location, common, datacontext) {
