(function () {
    'use strict';
    var controllerId = 'ResolvedJobSV';
    angular
        .module('app')
        .controller('ResolvedJobSV', ResolvedJobSV);

    ResolvedJobSV.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function ResolvedJobSV($location, $scope, common, datacontext, model, resourceService) {
        ...
        function getUnFlaggedJobs(forceRefresh) {
            return datacontext.supervisor.getUnFlaggedJobs(forceRefresh).then(function (data) {
