(function () {
    'use strict';
    var controllerId = 'CompletedJobSv';
    angular
        .module('app')
        .controller('CompletedJobSv', CompletedJobSv);

    CompletedJobSv.$inject = ['$location', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function CompletedJobSv($location, $routeParams, $scope, common, config, datacontext, model, resourceService) {
