(function () {
    'use strict';
    var controllerId = 'OlderCompletedJobSv';
    angular
        .module('app')
        .controller('OlderCompletedJobSv', OlderCompletedJobSv);

    OlderCompletedJobSv.$inject = ['$location', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function OlderCompletedJobSv($location, $routeParams, $scope, common, config, datacontext, model, resourceService) {
