(function () {
    'use strict';
    var controllerId = 'RecentCompletedJobSv';
    angular
        .module('app')
        .controller('RecentCompletedJobSv', RecentCompletedJobSv);

    RecentCompletedJobSv.$inject = ['$location', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function RecentCompletedJobSv($location, $routeParams, $scope, common, config, datacontext, model, resourceService) {
