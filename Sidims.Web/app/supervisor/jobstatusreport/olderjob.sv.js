(function () {
    'use strict';
    var controllerId = 'OlderJobSv';
    angular
        .module('app')
        .controller('OlderJobSv', OlderJobSv);

    OlderJobSv.$inject = ['$location', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function OlderJobSv($location, $routeParams, $scope, common, config, datacontext, model, resourceService) {
