(function () {
    'use strict';
    var controllerId = 'OlderPendingJobSv';
    angular
        .module('app')
        .controller('OlderPendingJobSv', OlderPendingJobSv);

    OlderPendingJobSv.$inject = ['$location', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function OlderPendingJobSv($location, $routeParams, $scope, common, config, datacontext, model, resourceService) {
