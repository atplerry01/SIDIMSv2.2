(function () {
    'use strict';
    var controllerId = 'FlaggedJobSV';
    angular
        .module('app')
        .controller('FlaggedJobSV', FlaggedJobSV);

    FlaggedJobSV.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function FlaggedJobSV($location, $scope, common, datacontext, model, resourceService) {
        ...
        function getFlaggedJobs(forceRefresh) {
            return datacontext.supervisor.getFlaggedJobs(forceRefresh).then(function (data) {
