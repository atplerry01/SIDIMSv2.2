(function () {
    'use strict';
    var controllerId = 'UnitFlaggedJob';
    angular
        .module('app')
        .controller('UnitFlaggedJob', UnitFlaggedJob);

    UnitFlaggedJob.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function UnitFlaggedJob($location, $scope, common, datacontext, model, resourceService) {
