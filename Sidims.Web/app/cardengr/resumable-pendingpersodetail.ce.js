(function () {
    'use strict';
    var controllerId = 'ResumablePendingPersoDetailCE';
    angular
        .module('app')
        .controller('ResumablePendingPersoDetailCE', ResumablePendingPersoDetailCE);

    ResumablePendingPersoDetailCE.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext', 'model', 'resourceService', 'authService'];

    function ResumablePendingPersoDetailCE($location, $routeParams, $scope, common, datacontext, model, resourceService, authService) {
