(function () {
    'use strict';
    var controllerId = 'UnitFlaggedJobCE';
    angular
        .module('app')
        .controller('UnitFlaggedJobCE', UnitFlaggedJobCE);

    UnitFlaggedJobCE.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function UnitFlaggedJobCE($location, $scope, common, datacontext, model, resourceService) {
