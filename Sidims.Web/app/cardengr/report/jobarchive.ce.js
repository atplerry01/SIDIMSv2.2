(function () {
    'use strict';
    var controllerId = 'JobArchiveCE';
    angular
        .module('app')
        .controller('JobArchiveCE', JobArchiveCE);

    JobArchiveCE.$inject = ['$location', '$routeParams', '$scope', 'common', 'config', 'datacontext', 'model', 'resourceService'];

    function JobArchiveCE($location, $routeParams, $scope, common, config, datacontext, model, resourceService) {
