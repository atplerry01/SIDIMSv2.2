(function () {
    'use strict';
    var controllerId = 'WastePendingQA';
    angular
        .module('app')
        .controller('WastePendingQA', WastePendingQA);

    WastePendingQA.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function WastePendingQA($location, $routeParams, $scope, common, datacontext, model, resourceService) {
        ...
        function activate() {
            ...
            var promises = [getQAWastePendings()];
        ...
        function getQAWastePendings(forceRefresh) {
            return datacontext.resourcejob.getPendingWasteRequests(forceRefresh).then(function (data) {
