(function () {
    'use strict';
    var controllerId = 'UnitFlaggedJobQA';
    angular
        .module('app')
        .controller('UnitFlaggedJobQA', UnitFlaggedJobQA);

    UnitFlaggedJobQA.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function UnitFlaggedJobQA($location, $scope, common, datacontext, model, resourceService) {
