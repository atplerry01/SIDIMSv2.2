(function () {
    'use strict';
    var controllerId = 'UnitFlaggedJobQC';
    angular
        .module('app')
        .controller('UnitFlaggedJobQC', UnitFlaggedJobQC);

    UnitFlaggedJobQC.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function UnitFlaggedJobQC($location, $scope, common, datacontext, model, resourceService) {
