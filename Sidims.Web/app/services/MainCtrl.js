(function () {
    ...
    MainCtrl.$inject = ['$ocLazyLoad', '$scope', '$rootScope', '$location', '$layout', '$layoutToggles', '$pageLoadingBar', 'Fullscreen'];

    function MainCtrl($ocLazyLoad, $scope, $rootScope, $location, $layout, $layoutToggles, $pageLoadingBar, Fullscreen) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MainCtrl';

        //Todo: $ocLazyLoad.load('app/home/test.js');
