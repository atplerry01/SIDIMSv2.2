(function () {
    'use strict';
    var controllerId = 'ClientCO';
    angular
        .module('app')
        .controller('ClientCO', ClientCO);

    ClientCO.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function ClientCO($location, $routeParams, $scope, common, datacontext, model, resourceService) {
