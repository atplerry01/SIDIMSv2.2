(function () {
    'use strict';
    var controllerId = 'CardDeliveryReportPR';
    angular
        .module('app')
        .controller('CardDeliveryReportPR', CardDeliveryReportPR);

    CardDeliveryReportPR.$inject = ['$location', 'common', 'datacontext'];

    function CardDeliveryReportPR($location, common, datacontext) {
