(function () {
    'use strict';
    var controllerId = 'UnitFlaggedJobPR';
    angular
        .module('app')
        .controller('UnitFlaggedJobPR', UnitFlaggedJobPR);

    UnitFlaggedJobPR.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function UnitFlaggedJobPR($location, $scope, common, datacontext, model, resourceService) {
