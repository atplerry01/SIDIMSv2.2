(function () {
    'use strict';
    var controllerId = 'WasteJobLogIN';
    angular
        .module('app')
        .controller('WasteJobLogIN', WasteJobLogIN);

    WasteJobLogIN.$inject = ['$location', 'common', 'datacontext'];


    function WasteJobLogIN($location, $routeParams, $scope, $window, common, datacontext) {
