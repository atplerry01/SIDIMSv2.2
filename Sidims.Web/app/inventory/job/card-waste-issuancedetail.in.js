(function () {
    'use strict';
    var controllerId = 'CardWasteIssuanceDetailInventIN';
    angular
        .module('app')
        .controller('CardWasteIssuanceDetailInventIN', CardWasteIssuanceDetailInventIN);

    CardWasteIssuanceDetailInventIN.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function CardWasteIssuanceDetailInventIN($location, $routeParams, $scope, common, datacontext, model, resourceService) {
        ...
        function save() {
            ...
            vm.newEntity = {
                ...
                JobSplitCEAnalysisId: vm.cardWaste.jobSplitCEAnalysisId,
        ...
        function createEntity(entity) {
            var resourceUri = model.resourceUri.inventory + '/waste/cardissuance/create';
