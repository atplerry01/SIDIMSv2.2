(function () {
    'use strict';
    var controllerId = 'JobListIN';
    angular
        .module('app')
        .controller('JobListIN', JobListIN);

    JobListIN.$inject = ['$location', '$routeParams', 'common', 'config', 'datacontext'];

    function JobListIN($location, $routeParams, common, config, datacontext) {
        ...
        function getProducts(forceRefresh) {
            var val = 1; //$routeParams.clientId; //
