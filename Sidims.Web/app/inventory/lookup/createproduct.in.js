(function () {
    'use strict';
    var controllerId = 'CreateProductIN';
    angular
        .module('app')
        .controller('CreateProductIN', CreateProductIN);

    CreateProductIN.$inject = ['$location', '$routeParams', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function CreateProductIN($location, $routeParams, $scope, common, datacontext, model, resourceService) {
