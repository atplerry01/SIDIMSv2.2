(function () {
    'use strict';
    var controllerId = 'MISClientsIN';
    angular
        .module('app')
        .controller('MISClientsIN', MISClientsIN);

    MISClientsIN.$inject = ['$location', '$routeParams', 'common', 'config', 'datacontext'];

    function MISClientsIN($location, $routeParams, common, config, datacontext) {
