(function () {
    'use strict';
    var controllerId = 'MISCardProductDetailIN';
    angular
        .module('app')
        .controller('MISCardProductDetailIN', MISCardProductDetailIN);

    MISCardProductDetailIN.$inject = ['$location', '$routeParams', 'common', 'config', 'datacontext'];

    function MISCardProductDetailIN($location, $routeParams, common, config, datacontext) {
