(function () {
    'use strict';
    var controllerId = 'productsIN';
    angular
        .module('app')
        .controller('productsIN', MISCardProductListIN);

    MISCardProductListIN.$inject = ['$location', '$routeParams', 'common', 'config', 'datacontext'];

    function MISCardProductListIN($location, $routeParams, common, config, datacontext) {
