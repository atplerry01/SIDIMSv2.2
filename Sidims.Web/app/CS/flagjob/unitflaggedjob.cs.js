(function () {
    'use strict';
    var controllerId = 'UnitFlaggedJobCS';
    angular
        .module('app')
        .controller('UnitFlaggedJobCS', UnitFlaggedJobCS);

    UnitFlaggedJobCS.$inject = ['$location', '$scope', 'common', 'datacontext', 'model', 'resourceService'];

    function UnitFlaggedJobCS($location, $scope, common, datacontext, model, resourceService) {
